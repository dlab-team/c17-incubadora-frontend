  ...
  return (
    <Container className=" bg-white d-flex  ">
      ...
      <MenuProfile />
        ...
        <Col xs={12} md={9} className="p-md-5" >
          <Col xs={12} md={12}>
            <h1 className="text-bienvenido pt-5 pb-4 text-start ">
              ¡Bienvenido!
            </h1>
          </Col>
          ...
          <Row md={3} className="justify-content-md-center pt-5 pb-md-4 ">
            <Col xs={6} md={5}>
              <p className="text-sube-cv text-start ">
                {" "}
                <LuFileInput className="mx-3" size={"24px"} /> Sube tu CV
              </p>
            </Col>
            ...
            <Col xs={3} md={2} className="text-md-end">
              <a href="" target="_blank">
                <FiEdit2 style={{ color: "#232323" }} size={"24px"} />
              </a>
            </Col>
          </Row>
          ...
          <Row md={12} className="justify-content-md-center pb-md-4">
            <Col xs={12} md={4} className="text-lg-start">
              <p className="text-email  text-start ">
                {" "}
                <MdOutlineEmail className="mx-3 " size={"24px"} />{" "}
                ejemplo@correo.com
              </p>
            </Col>
            ...
            <Col xs={12} md={3}>
              <p className="text-email text-start ">
                {" "}
                <LuPhone className="mx-3" size={"24px"} /> 56987654321
              </p>
            </Col>
            ...
            <Col xs={12} md={5} className=" text-md-start d-flex">
              ...
              <a href="" target="_blank">
                <SiGithub style={{ color: "#232323" }} size={"32px"} />
              </a>
            </Col>
          </Row>
          ...
          <Row md={12} className="justify-content-md-center pt-4 pb-md-4">
            <Col xs={12} md={5} className="text-lg-start">
              <p className="text-sube-cv  text-start ">
                {" "}
                <LuBookOpenCheck className="mx-3 " size={"24px"} /> Experiencia
                Laboral
              </p>
            </Col>

            <Col xs={9} md={5}>
              <p className="text-experiencia text-md-end">
                {" "}
                1 a 3 años de experiencia
              </p>
              <p className="text-email text-md-end">
                {" "}
          ...
          <Row md={12} className="justify-content-md-center pt-4 pb-md-4">
            <Col xs={12} md={5} className="text-lg-start">
              <p className="text-sube-cv  text-start ">
                {" "}
                <LuCalendarCheck className="mx-3 " size={"24px"} />{" "}
                Disponibilidad
              </p>
            </Col>
          ...
          <Row md={12} className="justify-content-md-center pt-4 pb-md-4">
            <Col xs={12} md={5} className="text-lg-start">
              <p className="text-sube-cv  text-start ">
                {" "}
                <LuContact className="mx-3 " size={"24px"} /> Rol y salario
                actual
              </p>
            </Col>
          ...
          <Row md={12} className="justify-content-md-center pt-4 pb-md-4">
            <Col xs={9} md={10} className="text-lg-start pb-4">
              <p className="text-habilidades  text-start mx-3  ">
                {" "}
                Habilidades
              </p>
            </Col>
            ...
            <Row md={12} className="justify-content-md-left pb-3">
              <Col xs={6} md={2} className="jus">
                <p className="text-sube-cv text-md-start mx-1 ">
                  {" "}
                  Experimentado
                </p>
              </Col>
              <Col xs={3} md={4} className=" text-md-start mx-4 ">
                <span class="badge border border-primary font-badge mx-4 ">
                  CSS
                </span>
                <span class="badge border border-primary font-badge">
                  JavaScript
                </span>
              </Col>
            </Row>
          ...
          <Row md={12} className="justify-content-md-left pt-4 pb-md-5">
            ...
            <Col xs={6} md={12}>
              <p className="text-edu-fech text-lg-start mx-3">
                {" "}
                Mar 2021 - Mar 2022
              </p>
            </Col>
            ...
            <Col xs={4} md={6} className=" text-md-end ">
              ...
              <a href="" target="_blank">
                <FaRegTrashAlt style={{ color: "#232323" }} size={"24px"} />
              </a>
            </Col>

            <Col xs={6} md={12}>
              <p className="text-edu-fech text-start mx-3">
                {" "}
