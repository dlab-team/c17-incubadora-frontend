	...
	return (
		<section className="como-funcionamos-section">
			...
			<div className="cf-txt-1-izq">
				<h3 className="como-funcionamos-title">¿Cómo funcionamos?</h3>
				<h6>
					Da click a nuestro video y en sólo 60 segundos conoce
					Devsafio y cómo estamos cambiando el mundo TI, acelerando y
			...
			<div className="cf-txt-2-der">
				<div className="cf-txt-2-der-txt-y-logo">
					<div className="cf-txt-2-der-txt-y-logo-top">
						<h1>DEVSAFIO</h1>
						<h6>
							Un puente para impulsar potenciar y acelerar las
							carreras de programadores y la industria
							tecnológica.
						</h6>
					</div>
